						...
						<ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							{deals.map((deal) => (
								...
								>
									...
									<h3 className="text-xl font-semibold">{deal.crop?.name}</h3>

									<p>Listed Price : ₹{deal.listedPrice}/kg</p>

									<p>Current Offer : ₹{deal.currentOffer}/kg</p>

									{deal.agreedPrice && (
										<p>Agreed Price : ₹{deal.agreedPrice}/kg</p>
									)}
									...
									<p>
										Status :
										<span className="font-semibold ml-1">{deal.status}</span>
									</p>
